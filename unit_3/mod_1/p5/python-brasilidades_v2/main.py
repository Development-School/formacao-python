...
# print(r.json()['cep'])
print(r.json().get('cep')) # 01001-000
...
d = r.json()
print(f"O endereço do cep {d['cep']} fica na "
      f"{d['logradouro']} {d['complemento']} "
      f"no bairro {d['bairro']}, na cidade de "
      f"{d['localidade']}/{d['uf']}")

# O endereço do cep 01001-000 fica na Praça da Sé, lado ímpar
# no bairro Sé na cidade de São Paulo/SP
