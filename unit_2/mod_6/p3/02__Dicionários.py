...
# "Aparições traga para mim o valor da chave "quantidade"...
# print(aparicoes["quantidade"]) #Error pois não tratamos caso não exista o valor da chave informada
print(aparicoes.get("quantidade", 0)) #Se não existir retorne 0
# 0

print(aparicoes.get("cachorro", 0)) #Se não existir retorne 0, porém retornará "2" pois é o valor da chave informada
# 2

print(aparicoes.get("quantidade")) # Caso não informemos o valor, será tratado o erro e retornado "None"
# None
