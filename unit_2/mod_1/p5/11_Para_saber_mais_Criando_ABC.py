# -------------------------------------------------------------------- #
# 11. Para saber mais - Criando ABC
# -------------------------------------------------------------------- #
...
# Apenas com isso, podemos garantir que o __str__ será implementado nas nossas subclasses, se não for implementado
...
class Teste(Programa):
    ...
    #implementation for abstract method '__str__'
