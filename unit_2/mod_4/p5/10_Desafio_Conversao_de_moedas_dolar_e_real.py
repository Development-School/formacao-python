...
moeda_origem = extrator_url.get_valor_parametro("moedaOrigem") # real
moeda_destino = extrator_url.get_valor_parametro("moedaDestino") # dolar
quantidade = extrator_url.get_valor_parametro("quantidade") # 100
